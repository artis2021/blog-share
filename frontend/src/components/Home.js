...
function Home() {
  document.title = "Code Contribute | Home";

  return (
    <StyledDiv>
      <Navbar />
      <div className="content">
        Hi, I am <span>CodeContribute</span> You can use me to share your thoughts
      ...
      <footer>
        <span>
          {" "}
          <a href="https://github.com/Abhishekkumar2021/CodeContribute">
            {" "}
